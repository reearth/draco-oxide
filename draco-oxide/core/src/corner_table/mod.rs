pub mod all_inclusive_corner_table;
pub mod attribute_corner_table;
...
impl<'mesh> CornerTable<'mesh> {
    pub fn new(mesh_faces: &'mesh [[PointIdx; 3]], pos_att: &Attribute) -> Self {
    ...
    #[inline]
    pub fn vertex_valence(&self, v: VertexIdx) -> usize {
    ...
    #[inline]
    pub fn get_mesh_faces(&self) -> &[[PointIdx; 3]] {
        self.mesh_faces
    }

    #[inline]
    pub fn corner_to_vert(&self, corner: CornerIdx) -> VertexIdx {
...
#[cfg(test)]
mod tests {
    use crate::attribute::{AttributeDomain, AttributeType};
