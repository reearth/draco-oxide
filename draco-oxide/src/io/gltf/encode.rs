...
pub(crate) struct GltfPrimitive {
    ...
    pub feature_id_name_indices: std::collections::HashMap<i32, i32>,
}
...
pub(crate) struct GltfAsset {
    ...
    extensions_used: std::collections::HashSet<String>,
    extensions_required: std::collections::HashSet<String>,
...
impl GltfAsset {
    pub fn new() -> Self {
        Self {
            copyright: "Generated by draco-rs".to_string(),
            generator: "draco-rs".to_string(),
            version: String::new(),
            scenes: Vec::new(),
            scene_index: -1,
            nodes: Vec::new(),
            ...
            extensions_used: std::collections::HashSet::new(),
            extensions_required: std::collections::HashSet::new(),
        ...
        for (iteration_id, attr) in mesh.get_attributes().iter().enumerate() {
            ...
            match attr.get_attribute_type() {
                ...
                crate::core::attribute::AttributeType::Custom => {
                    ...
                    // For Custom attributes (like feature IDs), use FLOAT component type to match C++ reference
        ...
        if has_mesh_features {
            ...
            for (i, features) in primitive.mesh_features.iter().enumerate() {
                ...
                if features.get_attribute_index() != -1 {
                    if let Some(index) = primitive.feature_id_name_indices.get(&features.get_attribute_index()) {
                        write!(buf_out, ",\"attribute\":{}", index)?;
                    }
                }
