...
const EXPECT_TETRA_LEN: usize = 1091;
const EXPECT_TETRA_HASH: u64 = 14885541960429193824;
const EXPECT_SPHERE_LEN: usize = 1943;
const EXPECT_SPHERE_HASH: u64 = 9635588609689478110;
const EXPECT_TORUS_LEN: usize = 3238;
const EXPECT_TORUS_HASH: u64 = 3309000085711741209;
const EXPECT_BUNNY_LEN: usize = 69325;
const EXPECT_BUNNY_HASH: u64 = 2609762777239913130;
