...
struct OctahedronDifferenceInverseTransform<Data> {
    _marker: std::marker::PhantomData<Data>,
}

impl<Data> OctahedronDifferenceInverseTransform<Data> 
where
    Data: Vector,
{
    pub fn new() -> Self {
...
impl<Data> PredictionInverseTransformImpl for OctahedronDifferenceInverseTransform<Data> 
where
    Data: Vector,
{
    const ID: usize = 2;
