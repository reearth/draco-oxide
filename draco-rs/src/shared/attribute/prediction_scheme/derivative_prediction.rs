...
use crate::core::corner_table::{self, GenericCornerTable};
...
{
	fn predict_impl<F>(&self, values_up_till_now: &[NdVector<N,i32>], points: &[NdVector<3,F>], faces: &[[usize; 3]]) -> NdVector<N, i32>
		where
			F: Float,
