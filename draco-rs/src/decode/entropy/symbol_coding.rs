...
pub enum Err {
    ...
    #[error("Invalid inputs for decode_tagged_symbol(): It must be true that symbol.len()==num_symbols*num_components, but got symbol.len()={0}, num_symbols={1}, num_components={2}")]
